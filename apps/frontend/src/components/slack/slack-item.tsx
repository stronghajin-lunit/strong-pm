    ...
    >
      ...
      <div className="flex items-center gap-[10px] mb-[10px]">
        ...
        <a
          ...
          className="flex items-center gap-[4px] text-[11px] font-medium px-[8px] py-[3px] rounded-[6px] transition-colors hover:opacity-80 whitespace-nowrap"
      ...
      <div className="pl-[42px] flex items-center gap-2">
        ...
        <div
          ...
          className="flex items-center gap-1 text-[11px] font-medium px-2 py-[3px] rounded-[6px] whitespace-nowrap"
          style={
            aiProject
