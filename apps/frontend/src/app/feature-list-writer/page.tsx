...
const COLS = ['Project', 'Features', 'Requested', 'Completed', 'Status', 'Link']
...
export default function FeatureListWriterPage() {
  ...
  const handleRunComplete = (record: FeatureListRun) => {
  ...
  if (view === 'create') {
    return (
      <div className="px-7 py-6">
        ...
        <FeatureListForm onRunComplete={handleRunComplete} />
      </div>
    )
  }
